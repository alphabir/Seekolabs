  ...
  return (
    <section className="border-b border-border px-4 py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-3xl text-center animate-fade-in-up">
        ...
        <Link
          href="/careers"
          className="mt-8 inline-flex items-center gap-2 border border-foreground px-6 py-3 text-foreground transition duration-300 hover:bg-primary hover:text-background hover:border-primary sm:px-8 sm:py-4"
        >
          See jobs
