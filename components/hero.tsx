        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="animate-slide-in-left">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link href="/apps" className="inline-flex items-center gap-2 text-foreground transition duration-300 hover:gap-3 hover:text-primary">
                Explore Our Apps
                <svg className="h-4 w-4 transition duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
              <Link href="/contact" className="inline-flex items-center gap-2 border border-foreground px-6 py-3 text-foreground transition duration-300 hover:bg-primary hover:text-background hover:border-primary">
                Start a Project
              </Link>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center justify-center animate-slide-in-right">
            <div className="w-full aspect-square bg-surface rounded-lg flex items-center justify-center border border-border transition duration-300 hover:border-primary hover:shadow-lg hover:shadow-primary/20 cursor-pointer">
